...
//    public List<Student> findByNameNotIn(@PathVariable("age") Integer age) {
//        return studentRepo.findByAgeLessThan(age);
//    }
//    @GetMapping("findByFirstnameStarting")
//    public List<Student>findByFirstnameStartingWith(@PathVariable("name")String name){
